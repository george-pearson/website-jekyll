...
(function () {
  ...
  sobelColourImage.onload = function () {
    sobelColourCtx.drawImage(sobelColourImage, 0, 0);
  };

  var sobelColourApplied = false;
  sobelColourbutton.addEventListener("click", function () {
  ...
  ltSaturationInput.addEventListener("change", function (e) {
    ltSaturationValueDisplay.innerHTML = ltSaturationInput.value;
  });
  ltSelectButton.addEventListener("click", function () {
    ltFileInput.click();
  });
  ltFileInput.addEventListener("change", function (e) {
  ...
  function sobel(imageData, canvas, saturation) {
    ...
    var vertical = convolute(px, [-1, -2, -1, 0, 0, 0, 1, 2, 1]);
    var horizontal = convolute(px, [-1, 0, 1, -2, 0, 2, -1, 0, 1]);
